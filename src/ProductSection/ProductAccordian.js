...
const ProductAccordian = () => {
  ...
  <AccordionItem backgroundColor={'#FFFFFF'} margin={"25px"}>
    ...
    <AccordionPanel pb={4} margin={"15px auto"}>
      ...
      <ul style={{fontSize:'14px',fontWeight:'300',textAlign:'left'}}>
        ...
        <li style={{margin:'10px 20px'}}>For any other queries, do reach out to Metastic Care at 9431027434.</li>
      </ul>
    </AccordionPanel>
  </AccordionItem>
  <AccordionItem margin={"25px"}>
  ...
  <AccordionItem margin={"25px"}>
    ...
    <AccordionPanel pb={4} margin={"15px auto"}>
     <Text style={{fontSize:'14px',fontWeight:'300',textAlign:'left'}}>Keeping in mind the fiery spirit of the youth along with vibrant designs, Jack & Jones is a clothing brand targeted towards the fashion-forward generation. Browse through Metastic world to get your hands on Jack & Jones jackets and shirts.</Text>
    </AccordionPanel>
  </AccordionItem>
</Accordion>
        </Box>
